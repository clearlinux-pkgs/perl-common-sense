...
cd %{_builddir}/common-sense-3.74
...
cp %{_builddir}/common-sense-3.74/LICENSE %{buildroot}/usr/share/package-licenses/perl-common-sense/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/common/sense.pm
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/common/sense.pod
